...
interface IUpdateCreditCardItemModalProps {
  onClose: () => void;
  isOpen: boolean;
  sheetId: string;
  item: IBackItem;
...
export default function UpdateCreditCardItemModal({
  onClose,
  isOpen,
  item,
  sheetId,
}: IUpdateCreditCardItemModalProps) {
    ...
    <BaseModal isOpen={isOpen} onClose={onClose}>
      <form
        ...
        <div className="w-full my-2">
          <label
            htmlFor="name"
            className={errors.name && 'text-red-500 font-bold'}>
            Nome{errors.name && '*'}
          </label>
          <TextInput
            className="w-full"
        ...
        <div className="w-full my-2 flex flex-col">
          <label
            htmlFor="date"
            className={errors.date && 'text-red-500 font-bold'}>
        ...
        <div className="w-full my-2 flex flex-col">
          ...
          {errors.selectedCategoryId && (
            <p>{errors.selectedCategoryId.message}</p>
          )}
        </div>
